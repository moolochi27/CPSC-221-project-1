...
class Chain {
 ...
 private:
  ...
  /**
  * Returns a pointer to the first block in the uncrambled image.
  */
  Node * findStarter();

  /**
  * Given a pointer to a block position, returns a pointer to the block
  * That should be in that place in the unscrambled image.
  */
